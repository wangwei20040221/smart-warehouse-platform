...
public class TestCallExpressNewAPIService {
	...
	/**丰桥新沙箱测试顾客编码  请替换为你的顺丰客户编码
                      校验码  请替换为你的顺丰校验码
    **/
	private static final String CLIENT_CODE = "请替换为你的顺丰客户编码（前往丰桥平台获取）";  //此处替换为您在丰桥平台获取的顾客编码
	private static final String CHECK_WORD = "请替换为你的顺丰校验码（前往丰桥平台获取）";//此处替换为您在丰桥平台获取的校验码
...
//        String msgData =tools.packageMsgData(standardService);
        //找到下载sdk下json文件的路径
//        byte[] bytes = IoUtil.readBytes(new FileInputStream("D:\\ExpressJson\\01.order.json"));
        byte[] bytes = IoUtil.readBytes(new FileInputStream("D:\\ExpressJson\\02.order.query.json"));
...
//        byte[] bytes = IoUtil.readBytes(new FileInputStream("D:\\course\\wms\\资料\\SF-CSIM-EXPRESS-SDK-V2.1.7-20220224\\SF-CSIM-EXPRESS-SDK-V2.1.7\\json\\ExpressJson\\20.cloud_print_waybills_2.json"));
        ...
        params.put("serviceCode","EXP_RECE_SEARCH_ORDER_RESP");// 接口服务码
